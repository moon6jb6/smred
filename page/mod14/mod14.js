...
const MARTYRS = [
    { name: '陈树湘', origin: '湖南长沙', age: 29, last: '为苏维埃流尽最后一滴血',
      detail: '红34师师长，湘江战役中负责断后。腹部中弹被俘后，在担架上用手撕开腹部伤口，绞断肠子，壮烈牺牲。他用最惨烈的方式，践行了"为苏维埃流尽最后一滴血"的誓言。' },
    { name: '刘仁堪', origin: '江西莲花', age: 34, last: '革命一定会胜利',
      detail: '莲花县委书记，1929年被捕。敌人割掉他的舌头，他用脚蘸着自己的鲜血写下"革命成功万岁"六个字。就义时高呼口号，声音含糊但从未停止。' },
    { name: '方志敏', origin: '江西弋阳', age: 36, last: '可爱的中国',
      detail: '红十军团军政委员会主席，被捕时国民党士兵搜遍全身，只搜出一块怀表和一支钢笔。在狱中6个月写下《可爱的中国》《清贫》等13万字手稿。就义前从容写下："敌人只能砍下我们的头颅，决不能动摇我们的信仰。"' },
    { name: '瞿秋白', origin: '江苏常州', age: 36, last: '此地甚好',
      detail: '中国共产党早期领导人之一，翻译《国际歌》的中国人。1935年在福建长汀被捕，蒋介石亲自劝降，他拒绝。临刑前环顾四周，说："此地甚好。"盘腿而坐，从容就义。' },
    { name: '赵一曼', origin: '四川宜宾', age: 31, last: '未惜头颅新故国',
      detail: '东北抗联女政委，1935年受伤被俘。日军对她施以9个月的酷刑——电刑、灌辣椒水、烧红的烙铁——她始终未透露任何信息。临刑前给儿子留下遗书："母亲不用千言万语来教育你，就用实行来教育你。"' },
    { name: '杨靖宇', origin: '河南确山', age: 35, last: '我们中国人都投降了，还有中国吗？',
      detail: '东北抗联第一路军总司令，在零下40度的雪原中孤身与日军周旋5天5夜。牺牲后，日军剖开他的胃，发现里面只有棉絮、树皮和草根，没有一粒粮食。在场的日军无不震惊。' },
    { name: '左权', origin: '湖南醴陵', age: 37, last: '愿拼热血卫吾华',
      detail: '八路军副参谋长，八路军在抗日战争中牺牲的最高将领。1942年在山西辽县十字岭突围时，为掩护机关转移，被炮弹击中牺牲。年仅37岁，是八路军中最年轻的将领之一。' },
    { name: '张自忠', origin: '山东临清', age: 49, last: '为国家民族死之决心',
      detail: '国民党上将，枣宜会战中率部与日军血战。身中数弹仍坚持指挥，最终壮烈殉国。他是二战中同盟国牺牲的最高军衔将领。日军发现他的遗体后，列队敬礼。' },
    { name: '狼牙山五壮士', origin: '河北易县', age: 21, last: '打倒日本帝国主义',
      detail: '1941年，五位八路军战士为掩护群众和主力转移，将敌人引上狼牙山。弹药用尽后，砸碎枪支，纵身跳崖。葛振林、宋学义被树枝挂住幸存，马宝玉、胡德林、胡福才壮烈牺牲。' },
    { name: '董存瑞', origin: '河北怀来', age: 19, last: '为了新中国，前进！',
      detail: '1948年隆化战斗中，部队被一座桥型暗堡的火力压制。董存瑞主动请战，在找不到支撑点的情况下，用手托起炸药包，拉燃导火索。高喊"为了新中国，前进！"与暗堡同归于尽。' },
    { name: '邱少云', origin: '重庆铜梁', age: 26, last: '',
      detail: '1952年朝鲜战场，潜伏在敌人阵地前30米处。敌人的燃烧弹落在身边，烈火烧遍全身。为了不暴露500多名战友，他双手深深插入泥土，一动不动，直到壮烈牺牲。没有留下遗言。' },
    { name: '黄继光', origin: '四川中江', age: 21, last: '',
      detail: '1952年上甘岭战役中，部队被敌人暗堡火力压制，连续三次爆破均未成功。黄继光主动请战，在多处负伤、弹药用尽的情况下，用自己的胸膛堵住了敌人的机枪射孔，为部队冲锋打开了通路。没有留下遗言。' }
];
...
class Mod14LastStep {
    ...
    showMemorial() {
        ...
        setTimeout(() => {
            ...
            // 显示详情
            const detailEl = document.getElementById('martyr-detail');
            if (detailEl && martyr.detail) {
                setTimeout(() => {
                    detailEl.textContent = martyr.detail;
